...
#ifndef KALDI_CUDA_DECODER_BATCHED_THREADED_CUDA_DECODER_CUSTOMIZED_H_
#define KALDI_CUDA_DECODER_BATCHED_THREADED_CUDA_DECODER_CUSTOMIZED_H_
...
/*
 * BatchedThreadedNnet3CudaPipelineCustomized uses multiple levels of parallelism in order to
 ...
 */
class BatchedThreadedNnet3CudaPipelineCustomized {
public:
  BatchedThreadedNnet3CudaPipelineCustomized(const BatchedThreadedNnet3CudaPipelineConfig &config)
      : config_(config){};
...
private:
  ...
  void PrefixTaskToPendingTaskQueue(TaskState *task);
...
#endif  // KALDI_CUDA_DECODER_BATCHED_THREADED_CUDA_DECODER_CUSTOMIZED_H_
